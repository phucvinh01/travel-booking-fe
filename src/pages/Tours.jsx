            ...
            <div className='container-fluid mt-2'>
                ...
                <section className='mt-3'>
                    <Breadcrumb style={ { fontSize: 18 } }
                        items={ [
                            {
                                title: <Link style={ { fontSize: 18 } } to={ '/' }>Home</Link>,
                            },
                            {
                                title: <p style={ { cursor: "pointer", fontSize: 18 } }>Tours</p>,
                            },
                        ] }
                    />
                </section>
                <div style={ { height: 150 } } className='d-flex justify-content-end'>
                    <SearchFrom />
                </div>
                <div className='row'>
                    <div className='col-lg-2 col-md-3' style={ { borderRight: "1px solid #333", minHeight: "100vh" } }>
